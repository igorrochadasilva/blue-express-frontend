...
const Form = ({ handleApproverModal, handleModalStatus, onSubmitLogin, isLoading, user, requestData }: IForm) => {
      ...
      <Content>
        <div className="flex flex-col gap-4">
          ...
          <InputGroup>
            ...
            <label className="flex flex-col flex-1 mb-2">
              ...
              <select
                ...
                value={requestData?.typeContract}
              >
          ...
          <InputGroup>
            ...
            <label htmlFor="uf" className="flex flex-col flex-1 mb-2">
              UF
              <select className="rounded border-[1px] py-1 px-2 mt-2" {...register('uf')} value={requestData?.uf}>
          ...
          <InputGroup>
            ...
            <label htmlFor="frequency" className="flex flex-col flex-1 mb-2">
              ...
              <select
                ...
                value={requestData?.approvalLevel}
              >
