      ...
      <div className="w-96 h-40 bg-white relative z-20 rounded">
        ...
        <div className="mt-4">
          ...
          <div className="flex justify-evenly w-full mt-5 text-white font-semibold">
            <button onClick={setCloseModal} className="bg-slate-500 w-32 py-2 rounded hover:bg-slate-400">
              Close
            </button>
            <button onClick={action} className="bg-be_first_color w-32 py-2 rounded hover:bg-blue-400">
              Yes
            </button>
          </div>
        </div>
